...
//---------------------------- HandleMessage ----------------------------------
//-----------------------------------------------------------------------------
bool Goal_DefendFlag::HandleMessage(const Telegram& msg)
{
...
//-----------------------------------------------------------------------------
bool Goal_DefendFlag::hasItemBeenStolen()const
{
  if (m_pGiverTrigger &&
