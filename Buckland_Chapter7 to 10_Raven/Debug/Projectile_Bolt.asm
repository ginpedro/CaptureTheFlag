; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\CaptureTheFlag\Buckland_Chapter7 to 10_Raven\armory\Projectile_Bolt.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG139114 DB	'Bolt_Mass', 00H
	ORG $+2
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG139113 DB	'Bolt_MaxForce', 00H
	ORG $+2
$SG139115 DB	'Bolt_MaxSpeed', 00H
	ORG $+2
$SG139116 DB	'Bolt_Scale', 00H
	ORG $+1
$SG139117 DB	'Bolt_Damage', 00H
$SG139120 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	DB	'\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'j', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'i', 00H, 'l', 00H, 'e', 00H, '_', 00H, 'B', 00H
	DB	'o', 00H, 'l', 00H, 't', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p'
	DB	00H, 00H, 00H
	ORG $+2
$SG139121 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
...
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\armory\projectile_bolt.cpp
rdata$r	SEGMENT
...
; 28   : {
	...
	push	OFFSET $SG139113
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG139114
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG139115
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
...
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\armory\raven_projectile.h
rdata$r	SEGMENT
...
; File c:\users\victor\desktop\capturetheflag\common\time\crudetimer.h
CONST	SEGMENT
...
$T149702 = -56						; size = 16
$T149701 = -40						; size = 16
_dist$139139 = -20					; size = 8
_hit$139134 = -8					; size = 4
_this$ = -4						; size = 4
...
; 57   :                                                m_vPosition);
	...
	mov	DWORD PTR _hit$139134[ebp], eax

; 58   :     
; 59   :     //if hit
; 60   :     if (hit)

	cmp	DWORD PTR _hit$139134[ebp], 0
	je	SHORT $LN2@Update
...
; 66   :       //shot came from
; 67   : 	  if (hit->getTeam() != Shooter->getTeam()){

	mov	ecx, DWORD PTR _hit$139134[ebp]
...
; 68   :       Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 69   :                               m_iShooterID,
; 70   :                               hit->ID(),
; 71   :                               Msg_TakeThatMF,
; 72   : 							  (void*)&m_iDamageInflicted);}
...
; 73   :     }
; 74   : 
; 75   :     //test for impact with a wall
; 76   :     double dist;
; 77   :      if( FindClosestPointOfIntersectionWithWalls(m_vPosition - m_vVelocity,
; 78   :                                                  m_vPosition,
; 79   :                                                  dist,
; 80   :                                                  m_vImpactPoint,
; 81   :                                                  m_pWorld->GetMap()->GetWalls()))
	...
	push	edx
	lea	eax, DWORD PTR _dist$139139[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 24					; 00000018H
	sub	esp, 16					; 00000010H
...
; 98   :   int Shooterteam = Shooter->getTeam();

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+224]
	call	?getTeam@Raven_Bot@@QAEHXZ		; Raven_Bot::getTeam
	mov	DWORD PTR _Shooterteam$[ebp], eax

; 99   :   if (Shooterteam == 1) {gdi->ThickRedPen();};  

	cmp	DWORD PTR _Shooterteam$[ebp], 1
...
; 100  :   if (Shooterteam == 2) {gdi->ThickBluePen();};  

	cmp	DWORD PTR _Shooterteam$[ebp], 2
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$144812[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144812[ebp]
	push	edx
	lea	eax, DWORD PTR $T144814[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T149759[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144814[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T149774[ebp], eax
	lea	eax, DWORD PTR $T149774[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$141267[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$141267[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$141267[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$141246[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$141246[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	...
	and	eax, 1
	je	$LN5@operator@4
	and	DWORD PTR $T149928[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@4:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$144829[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144829[ebp]
	push	edx
	lea	eax, DWORD PTR $T144830[ebp]
	push	eax
	call	??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z ; std::operator+<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR tv74[ebp], eax
	...
	push	edx
	lea	ecx, DWORD PTR $T149978[ebp]
	call	??0runtime_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T149978[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144830[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
;	COMDAT xdata$x
; File c:\users\victor\desktop\capturetheflag\common\2d\wallintersectiontests.h
xdata$x	SEGMENT
...
$T149993 = -88						; size = 12
$T149992 = -73						; size = 1
_point$145191 = -68					; size = 16
_dist$145190 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$145190[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$145191[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$145191[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$145190[ebp]
	push	ecx
	lea	edx, DWORD PTR $T149994[ebp]
	push	edx
	lea	ecx, DWORD PTR _curWall$[ebp]
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$145190[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$145190[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$145191[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$145191[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$145191[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$145191[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$145985[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$145985[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150099[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150099[ebp], 0
	...
	mov	ecx, DWORD PTR $T150099[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T150099[ebp]
