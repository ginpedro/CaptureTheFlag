; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\CaptureTheFlag\Buckland_Chapter7 to 10_Raven\goals\Goal_FollowPath.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG144863 DB	'<Goal_FollowPath::Activate>: Unrecognized edge type', 00H
_pi	DQ	0400921f9f01b866er		; 3.14159
CONST	ENDS
...
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goals\goal_followpath.cpp
rdata$r	SEGMENT
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goals\goal_followpath.h
...
; 40   :       AddSubgoal(new Goal_TraverseEdge(m_pOwner, edge, m_Path.empty()));
	...
	add	esp, 4
	mov	DWORD PTR $T155834[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T155834[ebp], 0
...
$LN11@Activate:
	...
	mov	DWORD PTR $T155833[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	ecx, DWORD PTR $T155833[ebp]
	push	ecx
...
; 49   :       AddSubgoal(new Goal_NegotiateDoor(m_pOwner, edge, m_Path.empty()));
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T155838[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T155838[ebp], 0
...
$LN13@Activate:
	...
	mov	DWORD PTR $T155837[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	ecx, DWORD PTR $T155837[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _this$[ebp]
...
__unwindfunclet$?Activate@Goal_FollowPath@@UAEXXZ$0:
	mov	eax, DWORD PTR $T155834[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?Activate@Goal_FollowPath@@UAEXXZ$1:
	mov	eax, DWORD PTR $T155838[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\navigation\pathedge.h
_TEXT	ENDS
...
_TEXT	ENDS
PUBLIC	?reacifdeac@Goal_Think@@QAEXXZ			; Goal_Think::reacifdeac
...
; 89   :   }
; 90   :   if (m_iStatus == completed && m_Path.empty())
...
; 91   :   {//TESTE:se o bot acompanhar o outro com o request de defendflag, reativar o arbitrate
; 92   : 	  //"quando chegar na bandeira, se a urgencia for grande ele deve decidir proteger a bandeira"
; 93   : 	  m_pOwner->GetBrain()->reacifdeac();

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?GetBrain@Raven_Bot@@QAEQAVGoal_Think@@XZ ; Raven_Bot::GetBrain
	mov	ecx, eax
	call	?reacifdeac@Goal_Think@@QAEXXZ		; Goal_Think::reacifdeac
$LN1@Process:
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goals\goal_think.h
_TEXT	ENDS
;	COMDAT ?reacifdeac@Goal_Think@@QAEXXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?reacifdeac@Goal_Think@@QAEXXZ PROC			; Goal_Think::reacifdeac, COMDAT
; _this$ = ecx

; 66   :   void  reacifdeac() {if (deac) {deac = false;}}
...
$LN2@reacifdeac:
	...
	pop	ebp
	ret	0
?reacifdeac@Goal_Think@@QAEXXZ ENDP			; Goal_Think::reacifdeac
_TEXT	ENDS
...
; 103  :   //render all the path waypoints remaining on the path list
; 104  :   std::list<PathEdge>::iterator it;
...
; 105  :   for (it = m_Path.begin(); it != m_Path.end(); ++it)

	lea	eax, DWORD PTR $T155874[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
...
$LN3@Render:
	...
	mov	BYTE PTR $T155875[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T155876[ebp]
	call	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T155875[ebp]
	test	eax, eax
	je	$LN1@Render
...
; 108  :     gdi->LineWithArrow(it->Source(), it->Destination(), 5);

	sub	esp, 8
	fld	QWORD PTR __real@4014000000000000
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T155877[ebp]
	push	ecx
	lea	ecx, DWORD PTR _it$[ebp]
...
; 112  :     gdi->Circle(it->Destination(), 3);

	sub	esp, 8
	fld	QWORD PTR __real@4008000000000000
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T155879[ebp]
	push	ecx
	lea	ecx, DWORD PTR _it$[ebp]
	call	??C?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QBEPAVPathEdge@@XZ ; std::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::operator->
	mov	ecx, eax
...
; 114  : 
; 115  :   //forward the request to the subgoals
; 116  :   Goal_Composite<Raven_Bot>::Render();
...
; 284  :     Vector2D ArrowPoint1 = CrossingPoint + (norm.Perp() * 0.4f * size); 
	...
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T155903[ebp]
	push	edx
	lea	ecx, DWORD PTR _norm$[ebp]
	call	?Perp@Vector2D@@QBE?AU1@XZ		; Vector2D::Perp
	push	eax
	lea	eax, DWORD PTR $T155904[ebp]
	push	eax
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
...
; 285  :     Vector2D ArrowPoint2 = CrossingPoint - (norm.Perp() * 0.4f * size); 
	...
	call	?Perp@Vector2D@@QBE?AU1@XZ		; Vector2D::Perp
	push	eax
	lea	edx, DWORD PTR $T155907[ebp]
	push	edx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T155908[ebp]
	push	eax
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
...
; 294  :     p[0] = VectorToPOINT(ArrowPoint1);
	...
	add	esp, 4
	mov	DWORD PTR $T155909[ebp], eax
	mov	DWORD PTR $T155909[ebp+4], edx
	mov	edx, DWORD PTR $T155909[ebp]
	mov	DWORD PTR _p$[ebp], edx
	mov	eax, DWORD PTR $T155909[ebp+4]
...
; 295  :     p[1] = VectorToPOINT(ArrowPoint2);
	...
	call	?VectorToPOINT@@YA?AUtagPOINT@@ABUVector2D@@@Z ; VectorToPOINT
	add	esp, 4
	mov	DWORD PTR $T155910[ebp], eax
	mov	DWORD PTR $T155910[ebp+4], edx
	mov	edx, DWORD PTR $T155910[ebp]
	mov	DWORD PTR _p$[ebp+8], edx
	mov	eax, DWORD PTR $T155910[ebp+4]
...
; 296  :     p[2] = VectorToPOINT(to);                  
	...
	call	?VectorToPOINT@@YA?AUtagPOINT@@ABUVector2D@@@Z ; VectorToPOINT
	add	esp, 4
	mov	DWORD PTR $T155911[ebp], eax
	mov	DWORD PTR $T155911[ebp+4], edx
	mov	edx, DWORD PTR $T155911[ebp]
	mov	DWORD PTR _p$[ebp+16], edx
	mov	eax, DWORD PTR $T155911[ebp+4]
...
; 77   :   {throw std::runtime_error("Cannot add goals to atomic goals");}
	...
	lea	ecx, DWORD PTR $T156043[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T156043[ebp]
	push	eax
	call	__CxxThrowException@8
$LN2@AddSubgoal:
	add	esp, 16					; 00000010H
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T156083[ebp]
	or	ecx, 1
	mov	DWORD PTR $T156083[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@PBV?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >
	mov	eax, DWORD PTR $T156088[ebp]
	or	eax, 1
	mov	DWORD PTR $T156088[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 922  : 		erase(begin());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T156105[ebp], esp
	mov	edx, DWORD PTR tv92[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv94[ebp], eax
	lea	eax, DWORD PTR $T156107[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T156159[ebp]
	or	ecx, 1
	mov	DWORD PTR $T156159[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@PBV?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::_List_const_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >
	mov	eax, DWORD PTR $T156164[ebp]
	or	eax, 1
	mov	DWORD PTR $T156164[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	ecx, DWORD PTR $T156174[ebp]
	or	ecx, 1
	mov	DWORD PTR $T156174[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T156174[ebp]
	and	eax, 1
	je	$LN10@erase
	and	DWORD PTR $T156174[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
$LN10@erase:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@PBV?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >
	mov	edx, DWORD PTR $T156254[ebp]
	or	edx, 1
	mov	DWORD PTR $T156254[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T156254[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T156254[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T156338[ebp]
	or	edx, 1
	mov	DWORD PTR $T156338[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T156338[ebp]
	and	eax, 1
	je	$LN5@operator@8
	and	DWORD PTR $T156338[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@8:
	ret	0
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$147286[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$147286[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$147286[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T156478[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T156478[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
$T156490 = -16						; size = 4
$T156489 = -12						; size = 4
_StatusOfSubGoals$150803 = -8				; size = 4
_this$ = -4						; size = 4
...
; 106  :     delete m_SubGoals.front(); 
	...
	call	?front@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::front
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T156490[ebp], ecx
	mov	edx, DWORD PTR $T156490[ebp]
	mov	DWORD PTR $T156489[ebp], edx
	cmp	DWORD PTR $T156489[ebp], 0
	je	SHORT $LN9@ProcessSub
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T156489[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T156489[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 114  :     int StatusOfSubGoals = m_SubGoals.front()->Process();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _StatusOfSubGoals$150803[ebp], eax
...
; 120  :     if (StatusOfSubGoals == completed && m_SubGoals.size() > 1)
	...
	cmp	DWORD PTR _StatusOfSubGoals$150803[ebp], 2
...
; 125  :     return StatusOfSubGoals;
	...
	mov	eax, DWORD PTR _StatusOfSubGoals$150803[ebp]
	jmp	SHORT $LN7@ProcessSub
...
; 80   :   for (SubgoalList::iterator it = m_SubGoals.begin();
	...
	lea	eax, DWORD PTR _it$150864[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 16					; 00000010H
...
; 82   :        ++it)
	...
	lea	ecx, DWORD PTR _it$150864[ebp]
...
; 86   :     delete *it;
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T156502[ebp], ecx
	mov	edx, DWORD PTR $T156502[ebp]
	mov	DWORD PTR $T156501[ebp], edx
	cmp	DWORD PTR $T156501[ebp], 0
	je	SHORT $LN6@RemoveAllS
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T156501[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T156501[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
$LN3@RenderAtPo@2:
	...
	add	esp, 8
	mov	BYTE PTR $T156519[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T156520[ebp]
	call	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
	movzx	edx, BYTE PTR $T156519[ebp]
	test	edx, edx
...
; 1004 : 		_Insert(_Where, _First, _Last, _Iter_cat(_First));
	...
	add	esp, 8
	mov	dl, BYTE PTR [eax]
	mov	BYTE PTR $T156539[ebp], dl
	movzx	eax, BYTE PTR $T156539[ebp]
	push	eax
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T156541[ebp], esp
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T156633[ebp]
	or	ecx, 1
	mov	DWORD PTR $T156633[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	eax, DWORD PTR $T156638[ebp]
	or	eax, 1
	mov	DWORD PTR $T156638[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 811  : 		{	// return iterator for beginning of reversed nonmutable sequence
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T156647[ebp], 0

; 812  : 		return (const_reverse_iterator(end()));

	sub	esp, 12					; 0000000cH
	mov	eax, esp
	mov	DWORD PTR $T156643[ebp], esp
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	eax, DWORD PTR $T156647[ebp]
	or	eax, 1
	mov	DWORD PTR $T156647[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T156642[ebp]
	call	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?rbegin@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@2@XZ$2:
	...
	and	eax, 1
	je	$LN6@rbegin
	and	DWORD PTR $T156647[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
$LN6@rbegin:
	ret	0
...
; 822  : 		return (const_reverse_iterator(begin()));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	eax, DWORD PTR $T156662[ebp]
	or	eax, 1
	mov	DWORD PTR $T156662[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T156657[ebp]
	call	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?rend@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@2@XZ$2:
	...
	and	eax, 1
	je	$LN6@rend
	and	DWORD PTR $T156662[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
$LN6@rend:
	ret	0
...
; 897  : 		return (*begin());
	...
	mov	ecx, DWORD PTR tv72[ebp]
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	DWORD PTR $T156676[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T156677[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T156676[ebp]
...
; 922  : 		erase(begin());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T156699[ebp], esp
	mov	edx, DWORD PTR tv92[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv94[ebp], eax
	lea	eax, DWORD PTR $T156701[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::erase
	mov	DWORD PTR tv95[ebp], eax
	lea	ecx, DWORD PTR $T156701[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T156700[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T156718[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T156718[ebp], 0
	...
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	ecx, DWORD PTR $T156718[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T156718[ebp]
...
; 1045 : 		return (*--_Tmp);
	...
	mov	ecx, eax
	call	??D?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEABQAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	DWORD PTR $T156747[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T156747[ebp]
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T156776[ebp]
	or	ecx, 1
	mov	DWORD PTR $T156776[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	eax, DWORD PTR $T156781[ebp]
	or	eax, 1
	mov	DWORD PTR $T156781[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	DWORD PTR tv200[ebp], eax
	mov	ecx, DWORD PTR $T156800[ebp]
	or	ecx, 1
	mov	DWORD PTR $T156800[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T156800[ebp]
	and	eax, 1
	je	$LN10@erase@2
	and	DWORD PTR $T156800[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN10@erase@2:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	edx, DWORD PTR $T156848[ebp]
	or	edx, 1
	mov	DWORD PTR $T156848[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T156848[ebp]
	and	eax, 1
	je	$LN5@Make_iter@2
	and	DWORD PTR $T156848[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter@2:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T156885[ebp]
	or	edx, 1
	mov	DWORD PTR $T156885[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T156885[ebp]
	and	eax, 1
	je	$LN5@operator@14
	and	DWORD PTR $T156885[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@14:
	ret	0
...
; 1046 : 			const_iterator _Before = _Where;
	...
	lea	edx, DWORD PTR __Where$[ebp]
	push	edx
	lea	ecx, DWORD PTR __Before$152666[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1047 : 			erase(--_Before);
	...
	lea	eax, DWORD PTR $T156942[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?erase@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@@Z ; std::list<PathEdge,std::allocator<PathEdge> >::erase
	mov	DWORD PTR tv205[ebp], eax
	lea	ecx, DWORD PTR $T156942[ebp]
	call	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	lea	eax, DWORD PTR __First$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T157024[ebp]
	push	ecx
	call	??$_Iter_cat@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@@std@@YA?AUbidirectional_iterator_tag@0@ABV?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@0@@Z ; std::_Iter_cat<std::_List_const_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > > >
	add	esp, 8
	movzx	edx, BYTE PTR $T157025[ebp]
	push	edx
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T157043[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T157043[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABQAV?$Goal@VRaven_Bot@@@@@std@@YAABQAV?$Goal@VRaven_Bot@@@@ABQAV1@@Z ; std::forward<Goal<Raven_Bot> * const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T157043[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR $T157043[ebp]
	mov	DWORD PTR tv73[ebp], eax
	jmp	SHORT $LN4@Construct
$LN3@Construct:
...
; 1083 : 		return (current == _Right.base());
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	??8?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator==
	mov	BYTE PTR $T157061[ebp], al
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T157062[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T157061[ebp]
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T157085[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T157085[ebp], 0
	...
	mov	ecx, 10					; 0000000aH
	mov	esi, eax
	mov	edi, DWORD PTR $T157085[ebp]
	rep movsd
	mov	eax, DWORD PTR $T157085[ebp]
	mov	DWORD PTR tv74[ebp], eax
...
; 1039 : 		return (current);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	ecx, DWORD PTR $T157098[ebp]
	or	ecx, 1
	mov	DWORD PTR $T157098[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
