; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\CaptureTheFlag\Buckland_Chapter7 to 10_Raven\Request_HelpDefendFlag.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	?setUrgency@bbRequest@@QAEXH@Z			; bbRequest::setUrgency
PUBLIC	?setType@bbRequest@@QAEXH@Z			; bbRequest::setType
PUBLIC	??0bbRequest@@QAE@PAVRaven_Bot@@@Z		; bbRequest::bbRequest
PUBLIC	??0Request_HelpDefendFlag@@QAE@PAVRaven_Bot@@@Z	; Request_HelpDefendFlag::Request_HelpDefendFlag
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\request_helpdefendflag.cpp
rtc$TMZ	SEGMENT
...
_this$ = -4						; size = 4
_owner$ = 8						; size = 4
??0Request_HelpDefendFlag@@QAE@PAVRaven_Bot@@@Z PROC	; Request_HelpDefendFlag::Request_HelpDefendFlag
; _this$ = ecx
...
; 4    : {
	...
	call	??0bbRequest@@QAE@PAVRaven_Bot@@@Z	; bbRequest::bbRequest

; 5    : 	setType(help_defend_flag);

	push	0
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setType@bbRequest@@QAEXH@Z		; bbRequest::setType

; 6    : 	setUrgency(urgent);

	push	1
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setUrgency@bbRequest@@QAEXH@Z		; bbRequest::setUrgency
...
; 7    : }
	...
	pop	ebp
	ret	4
??0Request_HelpDefendFlag@@QAE@PAVRaven_Bot@@@Z ENDP	; Request_HelpDefendFlag::Request_HelpDefendFlag
_TEXT	ENDS
PUBLIC	__real@bff0000000000000
EXTRN	__fltused:DWORD
;	COMDAT __real@bff0000000000000
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\bbrequest.h
CONST	SEGMENT
__real@bff0000000000000 DQ 0bff0000000000000r	; -1
; Function compile flags: /Odtp /RTCsu
CONST	ENDS
;	COMDAT ??0bbRequest@@QAE@PAVRaven_Bot@@@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_owner$ = 8						; size = 4
??0bbRequest@@QAE@PAVRaven_Bot@@@Z PROC			; bbRequest::bbRequest, COMDAT
; _this$ = ecx

; 30   : 	bbRequest(Raven_Bot* owner) {rBot = owner; bestOffer.sender = NULL; bestOffer.cost = -1; numSent = 0; numRec = -1; status = unaccepted;}
	...
	pop	ebp
	ret	4
??0bbRequest@@QAE@PAVRaven_Bot@@@Z ENDP			; bbRequest::bbRequest
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?setType@bbRequest@@QAEXH@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_val$ = 8						; size = 4
?setType@bbRequest@@QAEXH@Z PROC			; bbRequest::setType, COMDAT
; _this$ = ecx

; 31   : 	void setType(int val){type = val;}
	...
	pop	ebp
	ret	4
?setType@bbRequest@@QAEXH@Z ENDP			; bbRequest::setType
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?setUrgency@bbRequest@@QAEXH@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_val$ = 8						; size = 4
?setUrgency@bbRequest@@QAEXH@Z PROC			; bbRequest::setUrgency, COMDAT
; _this$ = ecx

; 36   : 	void setUrgency(int val){urgency = val;}
	...
	pop	ebp
	ret	4
?setUrgency@bbRequest@@QAEXH@Z ENDP			; bbRequest::setUrgency
_TEXT	ENDS
PUBLIC	?setNumRec@bbRequest@@QAEXH@Z			; bbRequest::setNumRec
PUBLIC	?getNumRec@bbRequest@@QAEHXZ			; bbRequest::getNumRec
PUBLIC	?setBestOffer@bbRequest@@QAEXPAVRaven_Bot@@N@Z	; bbRequest::setBestOffer
PUBLIC	?getBestOffer@bbRequest@@QAE?AUoffer@@XZ	; bbRequest::getBestOffer
PUBLIC	?calculatePrice@Request_HelpDefendFlag@@QAEXPAVRaven_Bot@@NH@Z ; Request_HelpDefendFlag::calculatePrice
...
_distFlag$ = 12						; size = 8
_hp$ = 20						; size = 4
?calculatePrice@Request_HelpDefendFlag@@QAEXPAVRaven_Bot@@NH@Z PROC ; Request_HelpDefendFlag::calculatePrice
; _this$ = ecx
...
; 11   : 	double rst = distFlag/hp;

	fild	DWORD PTR _hp$[ebp]
	fdivr	QWORD PTR _distFlag$[ebp]
	fstp	QWORD PTR _rst$[ebp]

; 12   : 	offer b = getBestOffer();

	lea	eax, DWORD PTR _b$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?getBestOffer@bbRequest@@QAE?AUoffer@@XZ ; bbRequest::getBestOffer

; 13   : 
; 14   : 	if ((b.cost == -1)||(rst < b.cost)){
	...
	jnp	SHORT $LN1@calculateP
	fld	QWORD PTR _b$[ebp+8]
	fcomp	QWORD PTR _rst$[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $LN2@calculateP
$LN1@calculateP:

; 15   : 		setBestOffer(pBot, rst);

	sub	esp, 8
	fld	QWORD PTR _rst$[ebp]
	fstp	QWORD PTR [esp]
	mov	ecx, DWORD PTR _pBot$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setBestOffer@bbRequest@@QAEXPAVRaven_Bot@@N@Z ; bbRequest::setBestOffer
$LN2@calculateP:

; 16   : 	}
; 17   : 	setNumRec(getNumRec()+1);

	mov	ecx, DWORD PTR _this$[ebp]
	call	?getNumRec@bbRequest@@QAEHXZ		; bbRequest::getNumRec
	add	eax, 1
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?setNumRec@bbRequest@@QAEXH@Z		; bbRequest::setNumRec
...
; 18   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN7@calculateP
...
$LN5@calculateP:
	DB	98					; 00000062H
	DB	0
?calculatePrice@Request_HelpDefendFlag@@QAEXPAVRaven_Bot@@NH@Z ENDP ; Request_HelpDefendFlag::calculatePrice
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\bbrequest.h
_TEXT	ENDS
;	COMDAT ?getBestOffer@bbRequest@@QAE?AUoffer@@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?getBestOffer@bbRequest@@QAE?AUoffer@@XZ PROC		; bbRequest::getBestOffer, COMDAT
; _this$ = ecx

; 33   : 	offer getBestOffer() {return bestOffer;}
	...
	pop	ebp
	ret	4
?getBestOffer@bbRequest@@QAE?AUoffer@@XZ ENDP		; bbRequest::getBestOffer
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?setBestOffer@bbRequest@@QAEXPAVRaven_Bot@@N@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
_cost$ = 12						; size = 8
?setBestOffer@bbRequest@@QAEXPAVRaven_Bot@@N@Z PROC	; bbRequest::setBestOffer, COMDAT
; _this$ = ecx

; 34   : 	void setBestOffer(Raven_Bot* pBot, double cost) {bestOffer.sender = pBot; bestOffer.cost = cost;}
	...
	pop	ebp
	ret	12					; 0000000cH
?setBestOffer@bbRequest@@QAEXPAVRaven_Bot@@N@Z ENDP	; bbRequest::setBestOffer
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?setNumRec@bbRequest@@QAEXH@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
_val$ = 8						; size = 4
?setNumRec@bbRequest@@QAEXH@Z PROC			; bbRequest::setNumRec, COMDAT
; _this$ = ecx

; 40   : 	void setNumRec(int val){numRec = val;}
	...
	pop	ebp
	ret	4
?setNumRec@bbRequest@@QAEXH@Z ENDP			; bbRequest::setNumRec
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ?getNumRec@bbRequest@@QAEHXZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
?getNumRec@bbRequest@@QAEHXZ PROC			; bbRequest::getNumRec, COMDAT
; _this$ = ecx

; 41   : 	int getNumRec(){return numRec;}
	...
	pop	ebp
	ret	0
?getNumRec@bbRequest@@QAEHXZ ENDP			; bbRequest::getNumRec
_TEXT	ENDS
