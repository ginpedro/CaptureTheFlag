; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\CaptureTheFlag\Buckland_Chapter7 to 10_Raven\Goal_GetFlag.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Activate@Goal_GetFlag@@UAEXXZ			; Goal_GetFlag::Activate
...
xdata$x	SEGMENT
__unwindtable$?Activate@Goal_GetFlag@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_GetFlag@@UAEXXZ$0
__ehfuncinfo$?Activate@Goal_GetFlag@@UAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?Activate@Goal_GetFlag@@UAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
xdata$x	ENDS
;	COMDAT rtc$TMZ
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goal_getflag.cpp
rtc$TMZ	SEGMENT
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Activate@Goal_GetFlag@@UAEXXZ PROC			; Goal_GetFlag::Activate
; _this$ = ecx
...
; 41   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Activate@Goal_GetFlag@@UAEXXZ
...
; 53   : 	op_flag = 1;
	...
	mov	DWORD PTR _op_flag$[ebp], 1
$LN1@Activate:

; 54   :   }
; 55   :   m_pOwner->GetPathPlanner()->RequestPathToOpponentFlag(op_flag);

	mov	eax, DWORD PTR _op_flag$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 59   :   AddSubgoal(new Goal_Wander(m_pOwner));
	...
	add	esp, 4
	mov	DWORD PTR $T154980[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T154980[ebp], 0
	je	SHORT $LN5@Activate
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
	mov	ecx, DWORD PTR $T154980[ebp]
...
$LN6@Activate:
	...
	mov	DWORD PTR $T154979[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	edx, DWORD PTR $T154979[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?Activate@Goal_GetFlag@@UAEXXZ$0:
	mov	eax, DWORD PTR $T154980[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?Activate@Goal_GetFlag@@UAEXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-28]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Activate@Goal_GetFlag@@UAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?Activate@Goal_GetFlag@@UAEXXZ ENDP			; Goal_GetFlag::Activate
; Function compile flags: /Odtp /RTCsu
...
PUBLIC	?hasItemBeenStolen@Goal_GetFlag@@ABE_NXZ	; Goal_GetFlag::hasItemBeenStolen
PUBLIC	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ	; Goal<Raven_Bot>::ActivateIfInactive
PUBLIC	?Process@Goal_GetFlag@@UAEHXZ			; Goal_GetFlag::Process
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goal_getflag.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_GetFlag@@UAEHXZ PROC			; Goal_GetFlag::Process
; _this$ = ecx
...
; 69   :   if (hasItemBeenStolen())
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?hasItemBeenStolen@Goal_GetFlag@@ABE_NXZ ; Goal_GetFlag::hasItemBeenStolen
	movzx	eax, al
	test	eax, eax
...
; 81   : }
	...
	pop	ebp
	ret	0
?Process@Goal_GetFlag@@UAEHXZ ENDP			; Goal_GetFlag::Process
_TEXT	ENDS
...
PUBLIC	?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z ; Goal_GetFlag::HandleMessage
...
xdata$x	SEGMENT
__unwindtable$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z$0
__ehfuncinfo$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
__$EHRec$ = -12						; size = 12
_msg$ = 8						; size = 4
?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z PROC	; Goal_GetFlag::HandleMessage
; _this$ = ecx
...
; 85   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 100  :                                      m_pOwner->GetPathPlanner()->GetPath()));
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T155015[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T155015[ebp], 0
	je	SHORT $LN9@HandleMess
	sub	esp, 16					; 00000010H
	mov	ecx, esp
	mov	DWORD PTR $T155016[ebp], esp
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?GetPathPlanner@Raven_Bot@@QAEQAVRaven_PathPlanner@@XZ ; Raven_Bot::GetPathPlanner
...
$LN10@HandleMess:
	...
	mov	DWORD PTR $T155014[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	ecx, DWORD PTR $T155014[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z$0:
	mov	eax, DWORD PTR $T155015[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-44]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?HandleMessage@Goal_GetFlag@@UAE_NABUTelegram@@@Z ENDP	; Goal_GetFlag::HandleMessage
...
$T155026 = -20						; size = 16
_this$ = -4						; size = 4
?hasItemBeenStolen@Goal_GetFlag@@ABE_NXZ PROC		; Goal_GetFlag::hasItemBeenStolen
; _this$ = ecx
...
; 137  : }
	...
	pop	ebp
	ret	0
?hasItemBeenStolen@Goal_GetFlag@@ABE_NXZ ENDP		; Goal_GetFlag::hasItemBeenStolen
; Function compile flags: /Odtp /RTCsu
...
; 77   :   {throw std::runtime_error("Cannot add goals to atomic goals");}
	...
	lea	ecx, DWORD PTR $T155036[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T155036[ebp]
	push	eax
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$146687[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$146687[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$146687[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T155121[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T155121[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
$T155135 = -16						; size = 4
$T155134 = -12						; size = 4
_StatusOfSubGoals$149985 = -8				; size = 4
_this$ = -4						; size = 4
...
; 106  :     delete m_SubGoals.front(); 
	...
	call	?front@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::front
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T155135[ebp], ecx
	mov	edx, DWORD PTR $T155135[ebp]
	mov	DWORD PTR $T155134[ebp], edx
	cmp	DWORD PTR $T155134[ebp], 0
	je	SHORT $LN9@ProcessSub
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T155134[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T155134[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 114  :     int StatusOfSubGoals = m_SubGoals.front()->Process();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _StatusOfSubGoals$149985[ebp], eax
...
; 120  :     if (StatusOfSubGoals == completed && m_SubGoals.size() > 1)
	...
	cmp	DWORD PTR _StatusOfSubGoals$149985[ebp], 2
...
; 125  :     return StatusOfSubGoals;
	...
	mov	eax, DWORD PTR _StatusOfSubGoals$149985[ebp]
	jmp	SHORT $LN7@ProcessSub
...
; 80   :   for (SubgoalList::iterator it = m_SubGoals.begin();
	...
	lea	eax, DWORD PTR _it$150046[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 16					; 00000010H
...
; 82   :        ++it)
	...
	lea	ecx, DWORD PTR _it$150046[ebp]
...
; 86   :     delete *it;
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T155145[ebp], ecx
	mov	edx, DWORD PTR $T155145[ebp]
	mov	DWORD PTR $T155144[ebp], edx
	cmp	DWORD PTR $T155144[ebp], 0
	je	SHORT $LN6@RemoveAllS
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T155144[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T155144[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T155232[ebp]
	or	ecx, 1
	mov	DWORD PTR $T155232[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	eax, DWORD PTR $T155237[ebp]
	or	eax, 1
	mov	DWORD PTR $T155237[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 897  : 		return (*begin());
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	DWORD PTR $T155245[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T155246[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T155245[ebp]
...
; 922  : 		erase(begin());
	...
	lea	eax, DWORD PTR $T155258[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::erase
	mov	DWORD PTR tv95[ebp], eax
	lea	ecx, DWORD PTR $T155258[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T155257[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	ecx, DWORD PTR $T155311[ebp]
	or	ecx, 1
	mov	DWORD PTR $T155311[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T155311[ebp]
	and	eax, 1
	je	$LN10@erase
	and	DWORD PTR $T155311[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN10@erase:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	edx, DWORD PTR $T155342[ebp]
	or	edx, 1
	mov	DWORD PTR $T155342[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T155342[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T155342[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T155359[ebp]
	or	edx, 1
	mov	DWORD PTR $T155359[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	...
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T155359[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
