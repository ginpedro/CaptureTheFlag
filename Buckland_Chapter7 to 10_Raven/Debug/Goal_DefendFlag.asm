; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\CaptureTheFlag\Buckland_Chapter7 to 10_Raven\Goal_DefendFlag.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z	; Raven_Game::AddRequest
...
PUBLIC	?Activate@Goal_DefendFlag@@UAEXXZ		; Goal_DefendFlag::Activate
EXTRN	??3@YAXPAX@Z:PROC				; operator delete
EXTRN	??2@YAPAXI@Z:PROC				; operator new
EXTRN	?RequestPathToOpponentFlag@Raven_PathPlanner@@QAE_NH@Z:PROC ; Raven_PathPlanner::RequestPathToOpponentFlag
...
xdata$x	SEGMENT
__unwindtable$?Activate@Goal_DefendFlag@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_DefendFlag@@UAEXXZ$0
__ehfuncinfo$?Activate@Goal_DefendFlag@@UAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?Activate@Goal_DefendFlag@@UAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
xdata$x	ENDS
;	COMDAT rtc$TMZ
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goal_defendflag.cpp
rtc$TMZ	SEGMENT
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Activate@Goal_DefendFlag@@UAEXXZ PROC			; Goal_DefendFlag::Activate
; _this$ = ecx
...
; 42   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Activate@Goal_DefendFlag@@UAEXXZ
...
; 54   : 	op_flag = 1;
; 55   :   }*/
; 56   :   m_pOwner->GetPathPlanner()->RequestPathToOpponentFlag(m_pOwner->getTeam());
	...
	mov	ecx, eax
	call	?RequestPathToOpponentFlag@Raven_PathPlanner@@QAE_NH@Z ; Raven_PathPlanner::RequestPathToOpponentFlag
...
; 58   : 	  m_pOwner->GetWorld()->AddRequest(m_pOwner,help_defend_flag);}
	...
	mov	ecx, eax
	call	?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z ; Raven_Game::AddRequest
$LN1@Activate:

; 59   :   
; 60   :   //the bot may have to wait a few update cycles before a path is calculated
; 61   :   //so for appearances sake it just wanders
; 62   :   AddSubgoal(new Goal_Wander(m_pOwner));

	push	16					; 00000010H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T157432[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T157432[ebp], 0
	je	SHORT $LN4@Activate
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	push	ecx
	mov	ecx, DWORD PTR $T157432[ebp]
...
$LN5@Activate:
	...
	mov	DWORD PTR $T157431[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	eax, DWORD PTR $T157431[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?Activate@Goal_DefendFlag@@UAEXXZ$0:
	mov	eax, DWORD PTR $T157432[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?Activate@Goal_DefendFlag@@UAEXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-24]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Activate@Goal_DefendFlag@@UAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?Activate@Goal_DefendFlag@@UAEXXZ ENDP			; Goal_DefendFlag::Activate
; Function compile flags: /Odtp /RTCsu
...
_TEXT	ENDS
EXTRN	?postRequest@Blackboard@@QAEXPAVbbRequest@@@Z:PROC ; Blackboard::postRequest
EXTRN	??0Request_HelpDefendFlag@@QAE@PAVRaven_Bot@@@Z:PROC ; Request_HelpDefendFlag::Request_HelpDefendFlag
EXTRN	?notPresent@Blackboard@@QAE_NH@Z:PROC		; Blackboard::notPresent
;	COMDAT xdata$x
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\raven_game.h
xdata$x	SEGMENT
__unwindtable$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z$0
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z$1
__ehfuncinfo$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z
_TEXT	SEGMENT
tv139 = -40						; size = 4
tv85 = -36						; size = 4
$T157464 = -32						; size = 4
...
_pBot$ = 8						; size = 4
_reqtype$ = 12						; size = 4
?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z PROC	; Raven_Game::AddRequest, COMDAT
; _this$ = ecx
...
; 171  :   {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 172  : 	  if (pBot->getTeam() == 1)

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?getTeam@Raven_Bot@@QAEHXZ		; Raven_Bot::getTeam
	cmp	eax, 1
	jne	SHORT $LN6@AddRequest

; 173  : 	  {
; 174  : 		  if (reqtype == help_defend_flag)

	cmp	DWORD PTR _reqtype$[ebp], 0
	jne	SHORT $LN5@AddRequest

; 175  : 		  {
; 176  : 			  if (BTeam1.notPresent(help_defend_flag)){

	push	0
	mov	ecx, DWORD PTR _this$[ebp]
	call	?notPresent@Blackboard@@QAE_NH@Z	; Blackboard::notPresent
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN5@AddRequest

; 177  : 				  BTeam1.postRequest(new Request_HelpDefendFlag(pBot));}

	push	40					; 00000028H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T157460[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T157460[ebp], 0
	je	SHORT $LN9@AddRequest
	mov	ecx, DWORD PTR _pBot$[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T157460[ebp]
	call	??0Request_HelpDefendFlag@@QAE@PAVRaven_Bot@@@Z ; Request_HelpDefendFlag::Request_HelpDefendFlag
	mov	DWORD PTR tv85[ebp], eax
	jmp	SHORT $LN10@AddRequest
$LN9@AddRequest:
	mov	DWORD PTR tv85[ebp], 0
$LN10@AddRequest:
	mov	edx, DWORD PTR tv85[ebp]
	mov	DWORD PTR $T157459[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	eax, DWORD PTR $T157459[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?postRequest@Blackboard@@QAEXPAVbbRequest@@@Z ; Blackboard::postRequest
$LN5@AddRequest:

; 178  : 		  }
; 179  : 	  }else

	jmp	SHORT $LN7@AddRequest
$LN6@AddRequest:

; 180  : 	  {
; 181  : 		  if (reqtype == help_defend_flag)

	cmp	DWORD PTR _reqtype$[ebp], 0
	jne	SHORT $LN7@AddRequest

; 182  : 		  {
; 183  : 			  if (BTeam2.notPresent(help_defend_flag)){
	...
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN7@AddRequest

; 184  : 				  BTeam2.postRequest(new Request_HelpDefendFlag(pBot));}

	push	40					; 00000028H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T157464[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T157464[ebp], 0
	je	SHORT $LN11@AddRequest
	mov	edx, DWORD PTR _pBot$[ebp]
	push	edx
	mov	ecx, DWORD PTR $T157464[ebp]
	call	??0Request_HelpDefendFlag@@QAE@PAVRaven_Bot@@@Z ; Request_HelpDefendFlag::Request_HelpDefendFlag
	mov	DWORD PTR tv139[ebp], eax
	jmp	SHORT $LN12@AddRequest
$LN11@AddRequest:
	mov	DWORD PTR tv139[ebp], 0
$LN12@AddRequest:
	mov	eax, DWORD PTR tv139[ebp]
	mov	DWORD PTR $T157463[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T157463[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 184				; 000000b8H
	call	?postRequest@Blackboard@@QAEXPAVbbRequest@@@Z ; Blackboard::postRequest
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z$0:
	mov	eax, DWORD PTR $T157460[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z$1:
	mov	eax, DWORD PTR $T157464[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-32]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?AddRequest@Raven_Game@@QAEXPAVRaven_Bot@@H@Z ENDP	; Raven_Game::AddRequest
...
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goals\goal_wander.h
rdata$r	SEGMENT
...
PUBLIC	?hasItemBeenStolen@Goal_DefendFlag@@ABE_NXZ	; Goal_DefendFlag::hasItemBeenStolen
PUBLIC	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ	; Goal<Raven_Bot>::ActivateIfInactive
PUBLIC	?Process@Goal_DefendFlag@@UAEHXZ		; Goal_DefendFlag::Process
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goal_defendflag.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_DefendFlag@@UAEHXZ PROC			; Goal_DefendFlag::Process
; _this$ = ecx
...
; 70   :   ActivateIfInactive();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ ; Goal<Raven_Bot>::ActivateIfInactive

; 71   : 
; 72   :   if (hasItemBeenStolen())

	mov	ecx, DWORD PTR _this$[ebp]
	call	?hasItemBeenStolen@Goal_DefendFlag@@ABE_NXZ ; Goal_DefendFlag::hasItemBeenStolen
	movzx	eax, al
	test	eax, eax
...
; 78   :   {
; 79   :     //process the subgoals
; 80   :     m_iStatus = ProcessSubgoals();
...
; 84   : }
	...
	pop	ebp
	ret	0
?Process@Goal_DefendFlag@@UAEHXZ ENDP			; Goal_DefendFlag::Process
_TEXT	ENDS
...
PUBLIC	??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z	; Goal_AreaProtect::Goal_AreaProtect
PUBLIC	?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ ; std::list<PathEdge,std::allocator<PathEdge> >::pop_back
...
PUBLIC	?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z ; Goal_DefendFlag::HandleMessage
...
xdata$x	SEGMENT
__unwindtable$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z$1
	DD	00H
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z$2
__ehfuncinfo$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z DD 019930522H
	DD	03H
	DD	FLAT:__unwindtable$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
$T157487 = -52						; size = 4
$T157486 = -48						; size = 4
_path$145164 = -40					; size = 16
_bHandled$ = -17					; size = 1
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
_msg$ = 8						; size = 4
?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z PROC ; Goal_DefendFlag::HandleMessage
; _this$ = ecx
...
; 88   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 89   :   //first, pass the message down the goal hierarchy
; 90   :   bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 91   : 
; 92   :   //if the msg was not handled, test to see if this goal can handle it
; 93   :   if (bHandled == false)
...
; 96   :     {
; 97   :     case Msg_PathReady:
; 98   : 
; 99   :       //clear any existing goals
; 100  :       {
...
; 102  : 
; 103  : 	  std::list<PathEdge> path =  m_pOwner->GetPathPlanner()->GetPath();	  

	lea	ecx, DWORD PTR _path$145164[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?GetPathPlanner@Raven_Bot@@QAEQAVRaven_PathPlanner@@XZ ; Raven_Bot::GetPathPlanner
...
; 104  : 	  path.pop_back();
	...
	lea	ecx, DWORD PTR _path$145164[ebp]
	call	?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ ; std::list<PathEdge,std::allocator<PathEdge> >::pop_back

; 105  : 	  AddSubgoal(new Goal_AreaProtect(m_pOwner));

	push	40					; 00000028H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T157487[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T157487[ebp], 0
	je	SHORT $LN9@HandleMess
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	push	ecx
	mov	ecx, DWORD PTR $T157487[ebp]
	call	??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z ; Goal_AreaProtect::Goal_AreaProtect
...
$LN10@HandleMess:
	...
	mov	DWORD PTR $T157486[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	esi, esp
	mov	eax, DWORD PTR $T157486[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 106  :       AddSubgoal(new Goal_FollowPath(m_pOwner,
; 107  :                                      path));

	push	48					; 00000030H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T157491[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	cmp	DWORD PTR $T157491[ebp], 0
	je	SHORT $LN11@HandleMess
	sub	esp, 16					; 00000010H
	mov	ecx, esp
	mov	DWORD PTR $T157492[ebp], esp
	lea	edx, DWORD PTR _path$145164[ebp]
	push	edx
...
$LN12@HandleMess:
	...
	mov	DWORD PTR $T157490[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	esi, esp
	mov	ecx, DWORD PTR $T157490[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 108  : 	  
; 109  : 
; 110  :       //get the pointer to the item
; 111  :       m_pGiverTrigger = static_cast<Raven_Map::TriggerType*>(msg.ExtraInfo);
...
; 115  : 
; 116  : 
; 117  :     case Msg_NoPathAvailable:
; 118  : 
; 119  :       m_iStatus = failed;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+12], 3

; 120  : 
; 121  :       return true; //msg handled
...
; 129  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN20@HandleMess
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z$0:
	lea	ecx, DWORD PTR _path$145164[ebp]
...
__unwindfunclet$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z$1:
	mov	eax, DWORD PTR $T157487[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z$2:
	mov	eax, DWORD PTR $T157491[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-88]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?HandleMessage@Goal_DefendFlag@@UAE_NABUTelegram@@@Z ENDP ; Goal_DefendFlag::HandleMessage
PUBLIC	?RandBool@@YA_NXZ				; RandBool
PUBLIC	??0Vector2D@@QAE@XZ				; Vector2D::Vector2D
PUBLIC	??_7Goal_AreaProtect@@6B@			; Goal_AreaProtect::`vftable'
PUBLIC	??_R4Goal_AreaProtect@@6B@			; Goal_AreaProtect::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVGoal_AreaProtect@@@8			; Goal_AreaProtect `RTTI Type Descriptor'
PUBLIC	??_R3Goal_AreaProtect@@8			; Goal_AreaProtect::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2Goal_AreaProtect@@8			; Goal_AreaProtect::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@Goal_AreaProtect@@8		; Goal_AreaProtect::`RTTI Base Class Descriptor at (0,-1,0,64)'
EXTRN	??_EGoal_AreaProtect@@UAEPAXI@Z:PROC		; Goal_AreaProtect::`vector deleting destructor'
EXTRN	?Activate@Goal_AreaProtect@@UAEXXZ:PROC		; Goal_AreaProtect::Activate
EXTRN	?Process@Goal_AreaProtect@@UAEHXZ:PROC		; Goal_AreaProtect::Process
EXTRN	?Terminate@Goal_AreaProtect@@UAEXXZ:PROC	; Goal_AreaProtect::Terminate
EXTRN	?Render@Goal_AreaProtect@@UAEXXZ:PROC		; Goal_AreaProtect::Render
;	COMDAT ??_R1A@?0A@EA@Goal_AreaProtect@@8
; File c:\users\victor\desktop\capturetheflag\buckland_chapter7 to 10_raven\goal_areaprotect.h
rdata$r	SEGMENT
??_R1A@?0A@EA@Goal_AreaProtect@@8 DD FLAT:??_R0?AVGoal_AreaProtect@@@8 ; Goal_AreaProtect::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3Goal_AreaProtect@@8
rdata$r	ENDS
;	COMDAT ??_R2Goal_AreaProtect@@8
rdata$r	SEGMENT
??_R2Goal_AreaProtect@@8 DD FLAT:??_R1A@?0A@EA@Goal_AreaProtect@@8 ; Goal_AreaProtect::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@?$Goal@VRaven_Bot@@@@8
rdata$r	ENDS
;	COMDAT ??_R3Goal_AreaProtect@@8
rdata$r	SEGMENT
??_R3Goal_AreaProtect@@8 DD 00H				; Goal_AreaProtect::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2Goal_AreaProtect@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVGoal_AreaProtect@@@8
_DATA	SEGMENT
??_R0?AVGoal_AreaProtect@@@8 DD FLAT:??_7type_info@@6B@	; Goal_AreaProtect `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVGoal_AreaProtect@@', 00H
_DATA	ENDS
;	COMDAT ??_R4Goal_AreaProtect@@6B@
rdata$r	SEGMENT
??_R4Goal_AreaProtect@@6B@ DD 00H			; Goal_AreaProtect::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVGoal_AreaProtect@@@8
	DD	FLAT:??_R3Goal_AreaProtect@@8
rdata$r	ENDS
;	COMDAT ??_7Goal_AreaProtect@@6B@
CONST	SEGMENT
??_7Goal_AreaProtect@@6B@ DD FLAT:??_R4Goal_AreaProtect@@6B@ ; Goal_AreaProtect::`vftable'
	DD	FLAT:??_EGoal_AreaProtect@@UAEPAXI@Z
	DD	FLAT:?Activate@Goal_AreaProtect@@UAEXXZ
	DD	FLAT:?Process@Goal_AreaProtect@@UAEHXZ
	DD	FLAT:?Terminate@Goal_AreaProtect@@UAEXXZ
	DD	FLAT:?HandleMessage@?$Goal@VRaven_Bot@@@@UAE_NABUTelegram@@@Z
	DD	FLAT:?AddSubgoal@?$Goal@VRaven_Bot@@@@UAEXPAV1@@Z
	DD	FLAT:?RenderAtPos@?$Goal@VRaven_Bot@@@@UBEXAAUVector2D@@PAVTypeToString@@@Z
	DD	FLAT:?Render@Goal_AreaProtect@@UAEXXZ
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z$0
__ehfuncinfo$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z
_TEXT	SEGMENT
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
_pBot$ = 8						; size = 4
??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z PROC		; Goal_AreaProtect::Goal_AreaProtect, COMDAT
; _this$ = ecx
...
; 28   :   {}
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
	push	ecx
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7Goal_AreaProtect@@6B@
	mov	ecx, DWORD PTR _this$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z$0:
	mov	ecx, DWORD PTR _this$[ebp]
	jmp	??1?$Goal@VRaven_Bot@@@@UAE@XZ		; Goal<Raven_Bot>::~Goal<Raven_Bot>
__ehhandler$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-8]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0Goal_AreaProtect@@QAE@PAVRaven_Bot@@@Z ENDP		; Goal_AreaProtect::Goal_AreaProtect
...
_TEXT	ENDS
PUBLIC	??1Goal_AreaProtect@@UAE@XZ			; Goal_AreaProtect::~Goal_AreaProtect
; Function compile flags: /Odtp /RTCsu
;	COMDAT ??_GGoal_AreaProtect@@UAEPAXI@Z
_TEXT	SEGMENT
_this$ = -4						; size = 4
___flags$ = 8						; size = 4
??_GGoal_AreaProtect@@UAEPAXI@Z PROC			; Goal_AreaProtect::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
...
$LN1@scalar@2:
	...
	pop	ebp
	ret	4
??_GGoal_AreaProtect@@UAEPAXI@Z ENDP			; Goal_AreaProtect::`scalar deleting destructor'
; Function compile flags: /Odtp /RTCsu
_TEXT	ENDS
;	COMDAT ??1Goal_AreaProtect@@UAE@XZ
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1Goal_AreaProtect@@UAE@XZ PROC			; Goal_AreaProtect::~Goal_AreaProtect, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	push	ecx
	...
	pop	ebp
	ret	0
??1Goal_AreaProtect@@UAE@XZ ENDP			; Goal_AreaProtect::~Goal_AreaProtect
_TEXT	ENDS
...
$T157536 = -20						; size = 16
_this$ = -4						; size = 4
?hasItemBeenStolen@Goal_DefendFlag@@ABE_NXZ PROC	; Goal_DefendFlag::hasItemBeenStolen
; _this$ = ecx
...
; 138  :   if (m_pGiverTrigger &&
; 139  :       !m_pGiverTrigger->isActive() &&
; 140  :       m_pOwner->hasLOSto(m_pGiverTrigger->Pos()) )
...
; 146  : }
	...
	pop	ebp
	ret	0
?hasItemBeenStolen@Goal_DefendFlag@@ABE_NXZ ENDP	; Goal_DefendFlag::hasItemBeenStolen
; Function compile flags: /Odtp /RTCsu
...
; 77   :   {throw std::runtime_error("Cannot add goals to atomic goals");}
	...
	lea	ecx, DWORD PTR $T157546[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T157546[ebp]
	push	eax
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ$0
__ehfuncinfo$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
;	COMDAT ?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ
_TEXT	SEGMENT
tv129 = -60						; size = 4
tv128 = -56						; size = 4
tv94 = -52						; size = 4
...
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ PROC ; std::list<PathEdge,std::allocator<PathEdge> >::pop_back, COMDAT
; _this$ = ecx

; 931  : 		{	// erase element at end

	push	ebp
	mov	ebp, esp
	push	-1
	push	__ehhandler$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 932  : 		erase(--end());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T157599[ebp], esp
	push	eax
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv128[ebp], eax
	lea	edx, DWORD PTR $T157601[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	...
	lea	ecx, DWORD PTR $T157601[ebp]
	call	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T157600[ebp]
	call	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ$0:
	lea	ecx, DWORD PTR $T157600[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
__ehhandler$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-56]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?pop_back@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAEXXZ ENDP ; std::list<PathEdge,std::allocator<PathEdge> >::pop_back
; Function compile flags: /Odtp /RTCsu
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T157667[ebp]
	or	ecx, 1
	mov	DWORD PTR $T157667[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T157672[ebp]
	or	ecx, 1
	mov	DWORD PTR $T157672[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@PBV?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >
	mov	eax, DWORD PTR $T157677[ebp]
	or	eax, 1
	mov	DWORD PTR $T157677[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@PBV?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::_List_const_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >
	mov	eax, DWORD PTR $T157682[ebp]
	or	eax, 1
	mov	DWORD PTR $T157682[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	ecx, DWORD PTR $T157692[ebp]
	or	ecx, 1
	mov	DWORD PTR $T157692[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T157692[ebp]
	and	eax, 1
	je	$LN10@erase
	and	DWORD PTR $T157692[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
$LN10@erase:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@PBV?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >::_List_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > >
	mov	edx, DWORD PTR $T157733[ebp]
	or	edx, 1
	mov	DWORD PTR $T157733[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T157733[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T157733[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T157818[ebp]
	or	edx, 1
	mov	DWORD PTR $T157818[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T157818[ebp]
	and	eax, 1
	je	$LN5@operator@2
	and	DWORD PTR $T157818[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@2:
	ret	0
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$147685[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$147685[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$147685[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T157913[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T157913[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\capturetheflag\common\goals\goal_composite.h
...
$T157925 = -16						; size = 4
$T157924 = -12						; size = 4
_StatusOfSubGoals$151061 = -8				; size = 4
_this$ = -4						; size = 4
...
; 106  :     delete m_SubGoals.front(); 
	...
	call	?front@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::front
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T157925[ebp], ecx
	mov	edx, DWORD PTR $T157925[ebp]
	mov	DWORD PTR $T157924[ebp], edx
	cmp	DWORD PTR $T157924[ebp], 0
	je	SHORT $LN9@ProcessSub
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T157924[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T157924[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 114  :     int StatusOfSubGoals = m_SubGoals.front()->Process();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _StatusOfSubGoals$151061[ebp], eax
...
; 120  :     if (StatusOfSubGoals == completed && m_SubGoals.size() > 1)
	...
	cmp	DWORD PTR _StatusOfSubGoals$151061[ebp], 2
...
; 125  :     return StatusOfSubGoals;
	...
	mov	eax, DWORD PTR _StatusOfSubGoals$151061[ebp]
	jmp	SHORT $LN7@ProcessSub
...
; 80   :   for (SubgoalList::iterator it = m_SubGoals.begin();
	...
	lea	eax, DWORD PTR _it$151122[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 16					; 00000010H
...
; 82   :        ++it)
	...
	lea	ecx, DWORD PTR _it$151122[ebp]
...
; 86   :     delete *it;
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T157935[ebp], ecx
	mov	edx, DWORD PTR $T157935[ebp]
	mov	DWORD PTR $T157934[ebp], edx
	cmp	DWORD PTR $T157934[ebp], 0
	je	SHORT $LN6@RemoveAllS
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T157934[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T157934[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 1004 : 		_Insert(_Where, _First, _Last, _Iter_cat(_First));
	...
	add	esp, 8
	mov	dl, BYTE PTR [eax]
	mov	BYTE PTR $T157971[ebp], dl
	movzx	eax, BYTE PTR $T157971[ebp]
	push	eax
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T157973[ebp], esp
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T158042[ebp]
	or	ecx, 1
	mov	DWORD PTR $T158042[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	eax, DWORD PTR $T158047[ebp]
	or	eax, 1
	mov	DWORD PTR $T158047[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 897  : 		return (*begin());
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	DWORD PTR $T158055[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T158056[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T158055[ebp]
...
; 922  : 		erase(begin());
	...
	lea	eax, DWORD PTR $T158068[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::erase
	mov	DWORD PTR tv95[ebp], eax
	lea	ecx, DWORD PTR $T158068[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T158067[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T158085[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T158085[ebp], 0
	...
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	ecx, DWORD PTR $T158085[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T158085[ebp]
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	DWORD PTR tv200[ebp], eax
	mov	ecx, DWORD PTR $T158124[ebp]
	or	ecx, 1
	mov	DWORD PTR $T158124[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$3:
	...
	and	eax, 1
	je	$LN10@erase@2
	and	DWORD PTR $T158124[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN10@erase@2:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	edx, DWORD PTR $T158151[ebp]
	or	edx, 1
	mov	DWORD PTR $T158151[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T158151[ebp]
	and	eax, 1
	je	$LN5@Make_iter@2
	and	DWORD PTR $T158151[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter@2:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T158168[ebp]
	or	edx, 1
	mov	DWORD PTR $T158168[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T158168[ebp]
	and	eax, 1
	je	$LN5@operator@8
	and	DWORD PTR $T158168[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@8:
	ret	0
...
; 1046 : 			const_iterator _Before = _Where;
	...
	lea	edx, DWORD PTR __Where$[ebp]
	push	edx
	lea	ecx, DWORD PTR __Before$153906[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1047 : 			erase(--_Before);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T158203[ebp], esp
	push	eax
	call	??0?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv204[ebp], eax
	lea	eax, DWORD PTR $T158204[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?erase@?$list@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@2@@Z ; std::list<PathEdge,std::allocator<PathEdge> >::erase
	mov	DWORD PTR tv205[ebp], eax
	lea	ecx, DWORD PTR $T158204[ebp]
	call	??1?$_List_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@QAE@XZ
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	lea	eax, DWORD PTR __First$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T158286[ebp]
	push	ecx
	call	??$_Iter_cat@V?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@std@@@std@@YA?AUbidirectional_iterator_tag@0@ABV?$_List_const_iterator@V?$_List_val@VPathEdge@@V?$allocator@VPathEdge@@@std@@@std@@@0@@Z ; std::_Iter_cat<std::_List_const_iterator<std::_List_val<PathEdge,std::allocator<PathEdge> > > >
	add	esp, 8
	movzx	edx, BYTE PTR $T158287[ebp]
	push	edx
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T158321[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T158321[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABVPathEdge@@@std@@YAABVPathEdge@@ABV1@@Z ; std::forward<PathEdge const &>
	...
	mov	ecx, 10					; 0000000aH
	mov	esi, eax
	mov	edi, DWORD PTR $T158321[ebp]
	rep movsd
	mov	eax, DWORD PTR $T158321[ebp]
	mov	DWORD PTR tv74[ebp], eax
	jmp	SHORT $LN4@Construct
$LN3@Construct:
	mov	DWORD PTR tv74[ebp], 0
